...
<body class="bg-gray-100 min-h-screen flex antialiased" x-data="{ sidenav: true }">
    ...
    <div class="flex-1 flex flex-col min-w-0">
        <!-- Header -->
        <header class="mb-6 sticky top-0 z-10 bg-gray-100/80 backdrop-blur-md pt-6 px-6 pb-2">
            <div
                class="bg-white p-4 md:px-6 md:py-4 rounded-2xl shadow-sm border border-gray-100 flex items-center justify-between transition-all duration-200">

                <!-- Left Side: Toggle & Title -->
                <div class="flex items-center space-x-3.5">
                    <!-- Mobile Sidebar Toggle Button -->
                    <button @click="sidenav = !sidenav"
                        class="p-2 bg-gray-50 hover:bg-blue-50 hover:text-blue-600 rounded-xl border border-gray-200/80 text-gray-600 focus:outline-none md:hidden transition-colors">
                    ...
                    <div>
                        <h1 class="text-base md:text-lg font-bold text-gray-800 tracking-tight flex items-center gap-2">
                            HISTORY BARANG
                        </h1>
                        <p class="text-xs text-gray-400 font-medium mt-0.5">Seluruh Riwayat Peminjaman Dan Pengembalian Barang</p>
                    </div>
                </div>
        ...
        <main class="p-6 overflow-y-auto space-y-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-6 pt-2">
                ...
                <div class="relative flex flex-col rounded-xl bg-white text-gray-700 shadow-md">
                    <div
                        class="mx-4 rounded-xl overflow-hidden bg-gradient-to-tr from-blue-600 to-blue-400 text-white shadow-blue-500/40 shadow-lg absolute -mt-4 grid h-14 w-14 place-items-center">
                    ...
                    <div class="p-4 text-right">
                        <p class="text-sm font-normal text-gray-600">Total Item Aset</p>
                        <h4 class="text-2xl font-semibold text-gray-900">1,248</h4>
                    </div>
                    <div class="border-t border-gray-100 p-3">
                        <p class="text-xs font-normal text-gray-500">Total keseluruhan barang tercatat</p>
                    </div>
                </div>
                ...
                <div class="relative flex flex-col rounded-xl bg-white text-gray-700 shadow-md">
                    <div
                        class="mx-4 rounded-xl overflow-hidden bg-gradient-to-tr from-amber-500 to-amber-300 text-white shadow-amber-500/40 shadow-lg absolute -mt-4 grid h-14 w-14 place-items-center">
                    ...
                    <div class="p-4 text-right">
                        <p class="text-sm font-normal text-gray-600">Barang Sedang Dipinjam</p>
                        <h4 class="text-2xl font-semibold text-gray-900">2</h4>
                    </div>
                    <div class="border-t border-gray-100 p-3">
                        <p class="text-xs font-normal text-gray-500">Barang aktif di luar penyimpanan</p>
                    </div>
                </div>

                <!-- Card 3: Sudah Dikembalikan -->
                <div class="relative flex flex-col rounded-xl bg-white text-gray-700 shadow-md">
                    <div
                        class="mx-4 rounded-xl overflow-hidden bg-gradient-to-tr from-emerald-600 to-emerald-400 text-white shadow-emerald-500/40 shadow-lg absolute -mt-4 grid h-14 w-14 place-items-center">
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor"
                            class="w-6 h-6">
                            <path
                                d="M12.378 1.602a.75.75 0 00-.756 0L3 6.632l9 5.25 9-5.25-8.622-5.03zM21.75 7.93l-9 5.25v9l8.628-5.032a.75.75 0 00.372-.648V7.93zM2.25 7.93v8.55a.75.75 0 00.372.648L11.25 22.18v-9l-9-5.25z" />
                    ...
                    <div class="p-4 text-right">
                        <p class="text-sm font-normal text-gray-600">Barang Sudah Dikembalikan</p>
                        <h4 class="text-2xl font-semibold text-gray-900">1,246</h4>
                    </div>
                    <div class="border-t border-gray-100 p-3">
                        <p class="text-xs font-normal text-gray-500">Peminjaman selesai diproses</p>
                    </div>
                </div>
            ...
            <div class="flex flex-col sm:flex-row items-center justify-between gap-4 pt-2">
                <button type="button"
                    class="w-full sm:w-auto rounded-lg bg-blue-600 py-2.5 px-5 text-xs font-bold uppercase tracking-wider text-white shadow-md shadow-blue-500/20 transition-all hover:bg-blue-700 hover:shadow-lg focus:outline-none active:opacity-[0.85]">
                    + Buat Peminjaman
                </button>
                ...
                <div class="relative w-full sm:w-auto text-left">
                    <button id="dropdown-button" type="button"
                        class="inline-flex justify-between sm:justify-center items-center w-full sm:w-auto px-4 py-2 text-sm font-medium text-gray-700 bg-white border border-gray-300 rounded-md shadow-sm hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-blue-500">
                        Filter Status
                        <svg xmlns="http://www.w3.org/2000/svg" class="w-5 h-5 ml-2 -mr-1 text-gray-500"
                    ...
                    <div id="dropdown-menu"
                        ...
                        <div class="py-1 p-1" role="menu">
                            <a href="#"
                                class="block px-4 py-2 text-sm text-gray-700 hover:bg-blue-50 hover:text-blue-600 rounded-md transition duration-150"
                                role="menuitem">
                                Semua Status
                            </a>
                            <a href="#"
                                class="block px-4 py-2 text-sm text-amber-700 hover:bg-amber-50 rounded-md transition duration-150"
                                role="menuitem">
                                Sedang Dipinjam
                            </a>
                            <a href="#"
                                class="block px-4 py-2 text-sm text-emerald-700 hover:bg-emerald-50 rounded-md transition duration-150"
                                role="menuitem">
                                Sudah Dikembalikan
                            </a>
                        </div>
            ...
            <!-- Data Table Section -->
            <div
                class="relative flex flex-col w-full text-gray-700 bg-white shadow-md rounded-xl bg-clip-border overflow-hidden">
                <div class="overflow-x-auto">
                    <table class="w-full text-left table-auto min-w-max">
                        <thead>
                            <tr class="border-b border-slate-200 bg-slate-50">
                                <th class="p-4 text-xs font-semibold uppercase tracking-wider text-slate-500">No</th>
                                ...
                                <th
                                    ...
                                    Jumlah</th>
                                <th class="p-4 text-xs font-semibold uppercase tracking-wider text-slate-500">Tanggal
                                    Peminjaman</th>
                                ...
                                <td class="p-4 text-center">
                                    <button type="button" title="Hapus / Batal"
                                        ...
                                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                                            stroke-width="2" stroke="currentColor" class="w-5 h-5 mx-auto">
