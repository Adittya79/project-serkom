    ...
    <div class="min-h-screen flex" x-data="{ sidenav: true }">
        ...
        <div class="flex-1 flex flex-col min-w-0 overflow-hidden">
            ...
            <main class="flex-1 overflow-y-auto p-4 md:p-8">
                ...
                <!-- 1. Section Header -->
                <div class="mb-4">
                    <h1 class="text-2xl font-bold text-slate-800 tracking-tight">DAFTAR BARANG YANG SEDANG DIPINJAM</h1>
                    <p class="text-sm text-slate-500 mt-1">Ini adalah daftar detail barang yang sedang dipinjam saat ini
                    </p>
                </div>
